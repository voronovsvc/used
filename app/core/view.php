...
class View
{
    ...
    public function render($tpl_content)
		{ // метод render - конструирует страницу
        $js = $this->getJs();
        $css = $this->getCss();
        $title = $this->title;
        ob_start ();
    ...
    public function setTitle($title)
		{ //публичный метод-сеттер для титла
        $this->title = $title;
    }

    public function setLayout($layout)
		{ //публичный метод-сеттер для доп лайаутов
        $this->layout = $layout;
    }

    public function addJs($scripts)
		{ //сеттер addJs принимает параметр пути к скриптам
        //подключаем скрипты
    ...
    public function addCss($styles)
		{ //сеттер addcss принимает параметр пути к стилям
        //подключаем стили
